...
const file_echo_proto_rawDesc = "" +
	...
	"\x04Echo\x123\n" +
	"\bSendEcho\x12\x11.echo.EchoRequest\x1a\x12.echo.EchoResponse\"\x00B\vZ\tproto.comb\x06proto3"
...
var file_echo_proto_depIdxs = []int32{
	0, // 0: echo.Echo.SendEcho:input_type -> echo.EchoRequest
	1, // 1: echo.Echo.SendEcho:output_type -> echo.EchoResponse
