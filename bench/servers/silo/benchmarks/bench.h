...
class bench_runner;
extern void dcsl_create_runner_partitions( abstract_db *db,
                                    bench_runner* &runner,
              std::map<std::string, abstract_ordered_index *> &open_tables,
              std::map<std::string, std::vector<abstract_ordered_index *>> &partitions);

class bench_loader;
//extern void dcsl_init_mloaders(abstract_db *db,
//                          std::map<std::string, abstract_ordered_index *> &open_tables,
//                          std::map<std::string, std::vector<abstract_ordered_index *>> &partitions,
//                          std::vector<bench_loader *> &ret);


extern void dcsl_init_mloaders(bench_runner * runner, std::vector<bench_loader*> &ret);

class bench_worker;
void dcsl_init_mworkers(std::vector<bench_worker *> &workers, bench_runner *runner);
/*extern void dcsl_init_mworkers(std::vector<bench_worker *> &workers, size_t nthreads,
  abstract_db *db,
  std::map<std::string, abstract_ordered_index *> &open_tables,
  std::map<std::string, std::vector<abstract_ordered_index *>> &partitions,
...
extern void dcsl_exec(int worker_id, int nb, std::vector<bench_worker *> *workers);
