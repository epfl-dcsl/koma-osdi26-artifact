        ...
        \begin{subfigure}[b]{\KtlsEvalPanelWidth}
            ...
            \begin{tikzpicture} [scale=0.875, transform shape, trim axis left, trim axis right]
                \begin{axis}
                    ...
                    }{x expr=\thisrow{load_rakaia-tls(QPS)} / 1000, y=latency_rakaia-tls}{data/ktls_100us.csv}
                    ...
                    }{x expr=\thisrow{load_rakaia(QPS)} / 1000, y=latency_rakaia}{data/synthetic_80_100us.csv}
        ...
        \begin{subfigure}[b]{\KtlsEvalPanelWidth}
            ...
            \begin{tikzpicture} [scale=0.875, transform shape, trim axis left, trim axis right]
                \begin{axis}
                    ...
                    }{x expr=\thisrow{load_rakaia-tls(QPS)} / 1000, y=latency_rakaia-tls}{data/ktls_20us.csv}
