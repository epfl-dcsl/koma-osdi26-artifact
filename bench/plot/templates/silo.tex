...
\begin{figure*}[!t]
   \centering
    ...
    \begin{tikzpicture}[scale=0.875, transform shape]
        ...
        \addlegendimage{ultra thick, cRed!70, dashed}
        \addlegendentry{Delivery}

        \addlegendimage{ultra thick, cViolet!80, dashed}
        \addlegendentry{StockLevel}

        \addlegendimage{ultra thick, cYellow, solid}
        \addlegendentry{Overall}

        \addlegendimage{ultra thick, cGreen!80, dashed}
        \addlegendentry{NewOrder}

        \addlegendimage{ultra thick, cBlue!80, dashed}
        \addlegendentry{Payment}

        \addlegendimage{ultra thick, gray!80, dashed}
        \addlegendentry{OrderStatus}

        \SiloPlot{ultra thick, cRed!70, dashed}{x=latency_us, y=ccdf}{data/silo_ccdf_downsampled_Delivery.csv}
        \SiloPlot{ultra thick, cViolet!80, dashed}{x=latency_us, y=ccdf}{data/silo_ccdf_downsampled_StockLevel.csv}
        \SiloPlot{ultra thick, cYellow, solid}{x=latency_us, y=ccdf}{data/silo_ccdf_downsampled_all.csv}
        \SiloPlot{ultra thick, cGreen!80, dashed}{x=latency_us, y=ccdf}{data/silo_ccdf_downsampled_NewOrder.csv}
        \SiloPlot{ultra thick, cBlue!80, dashed}{x=latency_us, y=ccdf}{data/silo_ccdf_downsampled_Payment.csv}
        \SiloPlot{ultra thick, gray!80, dashed}{x=latency_us, y=ccdf}{data/silo_ccdf_downsampled_OrderStatus.csv}
        \end{axis}
    \end{tikzpicture}
