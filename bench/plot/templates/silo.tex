   ...
   \centering
    ...
    \begin{tikzpicture}[scale=0.875, transform shape]
        \begin{axis}
            ...
            \addlegendimage{rakaia_tlsStyle}
            ...
            }{x expr=\thisrow{load_silo-rakaia(QPS)} / 1000, y=latency_silo-rakaia}{data/silo_bench.csv}
            ...
            }{x expr=\thisrow{load_silo-rakaia-tls(QPS)} / 1000, y=latency_silo-rakaia-tls}{data/silo_tls.csv}
        \end{axis}
    \end{tikzpicture}
...
\begin{axis}
    ...
    legend style={
        ...
        /tikz/every even column/.append style={column sep=0.4cm},
            ...
            \addlegendimage{grpc_rakaiaStyle, dotted, mark=*, cViolet!80}
...
\SiloPlot{grpc_rakaiaStyle, dotted, mark=*, mark size=0.8pt}{x expr=\thisrow{load_silo-grpc-rakaia-go(QPS)}/1000, y=latency_silo-grpc-rakaia-go}{data/silo_grpc_24conn.csv}
...
\SiloPlot{grpc_rakaiaStyle}{x expr=\thisrow{load_silo-grpc-rakaia-go(QPS)}/1000, y=latency_silo-grpc-rakaia-go}{data/silo_grpc_5000conn.csv}
