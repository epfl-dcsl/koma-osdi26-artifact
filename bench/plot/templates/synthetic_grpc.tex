...
\begin{figure}[!t]
    ...
    \begin{subfigure}[b]{\linewidth}
        ...
        \begin{axis}
            ...
            \addlegendimage{grpc_komaStyle, dotted, cViolet!80, mark=*}
            ...
            \SyntheticGrpcPlot{
                grpc_komaStyle, line width=2pt, dotted, cViolet!70, mark=*,
                x filter/.code={
                    \IfStrEq{\thisrow{dist_config}}{exponential}{}{\def\pgfmathresult{}}
                }
            }{x expr=\thisrow{load_grpc-koma-go(QPS)} / 1000, y=latency_grpc-koma-go}{data/synthetic_grpc_24conn.csv}
    ...
    \begin{subfigure}[b]{\linewidth}
        \begin{tikzpicture} [scale=0.875, transform shape]
            \begin{axis}
                ...
                \SyntheticGrpcPlot{
                    grpc_komaStyle, line width=2pt,
                    x filter/.code={
                        \IfStrEq{\thisrow{dist_config}}{exponential}{}{\def\pgfmathresult{}}
                    }
                }{x expr=\thisrow{load_grpc-koma-go(QPS)} / 1000, y=latency_grpc-koma-go}{data/synthetic_grpc_5000conn.csv}
