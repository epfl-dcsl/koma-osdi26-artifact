        ...
        \begin{subfigure}[b]{\SyntheticHundredUsPanelWidth}
            ...
            \begin{tikzpicture}[scale=0.875, transform shape, trim axis left, trim axis right]
                \begin{axis}[
                    ...
                    \SyntheticHundredUsPlot{komaStyle, x filter/.code={\IfStrEq{\thisrow{dist_config}}{fixed}{}{\def\pgfmathresult{}}}}{x expr=\thisrow{load_koma(QPS)} / 1000, y=latency_koma}{data/synthetic_20_100us.csv}
        ...
        \begin{subfigure}[b]{\SyntheticHundredUsPanelWidth}
            ...
            \begin{tikzpicture}[scale=0.875, transform shape, trim axis left, trim axis right]
                \begin{axis}[
                    ...
                    \SyntheticHundredUsPlot{komaStyle, x filter/.code={\IfStrEq{\thisrow{dist_config}}{exponential}{}{\def\pgfmathresult{}}}}{x expr=\thisrow{load_koma(QPS)} / 1000, y=latency_koma}{data/synthetic_20_100us.csv}
        ...
        \begin{subfigure}[b]{\SyntheticHundredUsPanelWidth}
            ...
            \begin{tikzpicture}[scale=0.875, transform shape, trim axis left, trim axis right]
                \begin{axis}[
                    ...
                    \SyntheticHundredUsPlot{komaStyle, x filter/.code={\IfStrEq{\thisrow{dist_config}}{bimodal}{}{\def\pgfmathresult{}}}}{x expr=\thisrow{load_koma(QPS)} / 1000, y=latency_koma}{data/synthetic_20_100us.csv}
        ...
        \begin{subfigure}[b]{\SyntheticHundredUsPanelWidth}
            ...
            \begin{tikzpicture}[scale=0.875, transform shape, trim axis left, trim axis right]
                \begin{axis}[
                    ...
                    \SyntheticHundredUsPlot{komaStyle, x filter/.code={\IfStrEq{\thisrow{dist_config}}{fixed}{}{\def\pgfmathresult{}}}}{x expr=\thisrow{load_koma(QPS)} / 1000, y=latency_koma}{data/synthetic_80_100us.csv}
                    \SyntheticHundredUsSchedsimPlot{d}
                \end{axis}
            \end{tikzpicture}
        ...
        \begin{subfigure}[b]{\SyntheticHundredUsPanelWidth}
            ...
            \begin{tikzpicture}[scale=0.875, transform shape, trim axis left, trim axis right]
                \begin{axis}[
                    ...
                    \SyntheticHundredUsPlot{komaStyle, x filter/.code={\IfStrEq{\thisrow{dist_config}}{exponential}{}{\def\pgfmathresult{}}}}{x expr=\thisrow{load_koma(QPS)} / 1000, y=latency_koma}{data/synthetic_80_100us.csv}
        ...
        \begin{subfigure}[b]{\SyntheticHundredUsPanelWidth}
            ...
            \begin{tikzpicture}[scale=0.875, transform shape, trim axis left, trim axis right]
                \begin{axis}[
                    ...
                    \SyntheticHundredUsPlot{komaStyle, x filter/.code={\IfStrEq{\thisrow{dist_config}}{bimodal}{}{\def\pgfmathresult{}}}}{x expr=\thisrow{load_koma(QPS)} / 1000, y=latency_koma}{data/synthetic_80_100us.csv}
        ...
        \begin{subfigure}[b]{\SyntheticHundredUsPanelWidth}
            ...
            \begin{tikzpicture}[scale=0.875, transform shape, trim axis left, trim axis right]
                \begin{axis}[
                    ...
                    \SyntheticHundredUsPlot{komaStyle, x filter/.code={\IfStrEq{\thisrow{dist_config}}{fixed}{}{\def\pgfmathresult{}}}}{x expr=\thisrow{load_koma(QPS)} / 1000, y=latency_koma}{data/synthetic_5000_100us.csv}
                    \SyntheticHundredUsSchedsimPlot{d}
                \end{axis}
            \end{tikzpicture}
        ...
        \begin{subfigure}[b]{\SyntheticHundredUsPanelWidth}
            ...
            \begin{tikzpicture}[scale=0.875, transform shape, trim axis left, trim axis right]
                \begin{axis}[
                    ...
                    \SyntheticHundredUsPlot{komaStyle, x filter/.code={\IfStrEq{\thisrow{dist_config}}{exponential}{}{\def\pgfmathresult{}}}}{x expr=\thisrow{load_koma(QPS)} / 1000, y=latency_koma}{data/synthetic_5000_100us.csv}
        ...
        \begin{subfigure}[b]{\SyntheticHundredUsPanelWidth}
            ...
            \begin{tikzpicture}[scale=0.875, transform shape, trim axis left, trim axis right]
                \begin{axis}[
                    ...
                    \SyntheticHundredUsPlot{komaStyle, x filter/.code={\IfStrEq{\thisrow{dist_config}}{bimodal}{}{\def\pgfmathresult{}}}}{x expr=\thisrow{load_koma(QPS)} / 1000, y=latency_koma}{data/synthetic_5000_100us.csv}
