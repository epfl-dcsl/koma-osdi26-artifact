...
struct rakaia_tx_msg {
    unsigned int sent;
    unsigned int frag_offset;
    unsigned int msg_flags;
    bool started_tx;
    struct rakaia_sock *ksk; // rakaia socket the msg was written from;
    struct rakaia_psock *psock; // cached psock for fast TX routing
